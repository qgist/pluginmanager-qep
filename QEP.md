...
QGIS' Plugin management is hybrid. Compared to typical package managers such as `pip`, `conda`, `apt`, `yum` and `zypper`, QGIS is not just installing and uninstalling "packages". It also loads and starts as well as stops and unloads them.
